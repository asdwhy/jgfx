...
use super::{Intersection, AuxObjectData, aa_rectangles::xy_rect};
...
pub fn new(p0: Point3, p1: Point3, material: Arc<dyn Material>) -> Object {
    ...
    object_list::add(&mut sides, xy_rect::new(p0.x, p1.x, p0.z, p1.z, p1.y, material.clone()));
    object_list::add(&mut sides, xy_rect::new(p0.x, p1.x, p0.z, p1.z, p0.y, material.clone()));

    object_list::add(&mut sides, xy_rect::new(p0.y, p1.y, p0.z, p1.z, p1.x, material.clone()));
    object_list::add(&mut sides, xy_rect::new(p0.y, p1.y, p0.z, p1.z, p0.x, material.clone()));
